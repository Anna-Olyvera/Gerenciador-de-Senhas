...
rem Caminhos
set SPOTBUGS_DIR=C:\Users\Ana\Desktop\Gerenciador-de-Senhas\src\main\java\tools\spotbugs-4.9.3\spotbugs-4.9.3
set PLUGIN=%SPOTBUGS_DIR%\plugin\findsecbugs-plugin.jar
set JAR=%SPOTBUGS_DIR%\lib\spotbugs.jar
set OUT_DIR=C:\Users\Ana\Desktop\Gerenciador-de-Senhas\target
